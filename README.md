...
Proof over claims — problem, stack, and links.

| Project | What I built | Stack | Links |
| :--- | :--- | :--- | :--- |
| **JobMatch RAG** | Scraped remote jobs, hybrid retrieval, streaming JobCards for match discovery | TypeScript, RAG, Vercel | [Demo](https://job-rag-drab.vercel.app) · [Repo](https://github.com/JamesKevinJones/job-rag) |
| **MemoryVault AI** | Persistent memory for agents — store, recall, and ground LLM context | TypeScript, CockroachDB, AWS Bedrock | [Demo](https://memoryvault-ai-delta.vercel.app) · [Repo](https://github.com/JamesKevinJones/Memoryvault-ai) |
| **Folio** | Personal research desk: ask anything, see cited sources from web search | Python, grounded search | [Demo](https://folio-nine-gamma.vercel.app) · [Repo](https://github.com/JamesKevinJones/folio) |
| **Rate Limiter** | FastAPI sliding-window limiter with Redis/memory backends + live dashboard | Python, FastAPI, Redis | [Demo](https://rate-limiter-beige.vercel.app) · [Repo](https://github.com/JamesKevinJones/rate-limiter) |
...
Not a laundry list — each cluster maps to shipped work above.
...
- **Web Development Intern** — Oasis Infobyte (built and shipped web features in a professional sprint cycle).
- **IBM Z Datathon 2026** — RiskPulse: real-time payment risk on enterprise mainframe context.
- **32+ public repos** with live demos on Vercel across SaaS, AI, and systems experiments.
